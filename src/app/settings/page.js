...
import SetOrUpdateWithdrawalPasswordForm from './setOrUpdateWithdrawalPasswordForm'; // ✅ Updated import
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 text-white p-8">
      <motion.div
        ...
        className="max-w-6xl mx-auto bg-gray-900 p-6 rounded-2xl shadow-xl"
      >
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <motion.div
            ...
            className="flex-1 bg-gray-800 p-6 rounded-xl shadow-md transition-all flex flex-col gap-6"
          >
            {/* Change Password */}
            <div>
            ...
            <div>
              ...
              <SetOrUpdateWithdrawalPasswordForm /> {/* ✅ Updated usage */}
            </div>
          </motion.div>
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="flex-1 bg-gray-800 p-6 rounded-xl shadow-md transition-all"
          >
            <div className="flex items-center gap-2 mb-4">
